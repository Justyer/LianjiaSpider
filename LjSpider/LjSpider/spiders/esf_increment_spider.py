...
class EsfIrtSpider(CrawlSpider):
    ...
    custom_settings = {
        ...
        'JOBDIR': '/usr/local/crawler/dxc/common/lj/crawls/lj_get_esf_irt_%s' % datetime.date.today(),
        'LOG_FILE': '/usr/local/crawler/dxc/common/lj/logs/lj_es_irt_%s.log' % datetime.date.today(),
